                ...
                when (page) {
                    0 -> {
                        LyricBasicTab(
                            ...
                            rainbowLyric = rainbowLyric,
                            onRainbowLyricChange = { rainbowLyric = it; saveConfig(RootConstants.KEY_HOOK_RAINBOW_LYRIC, it) },
                    ...
                    1 -> {
                        LyricAdvancedTab(
                            ...
                            sustainGlow = sustainGlow,
                            onSustainGlowChange = { sustainGlow = it; saveConfig(RootConstants.KEY_HOOK_SUSTAIN_GLOW, it) },
